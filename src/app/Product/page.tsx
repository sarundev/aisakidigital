...
function CategoryIcon({ category }: { category: string }) {
  ...
  if (cat === 'facebook')  return <span style={{ display:'flex', alignItems:'center', justifyContent:'center', width:28, height:28, borderRadius:8, border:'1px solid rgba(0,0,0)', flexShrink:0 }}><img src="/image/facebook.png"  alt="Facebook"  width={20} height={20} style={{ display:'block', borderRadius:4 }} /></span>;
